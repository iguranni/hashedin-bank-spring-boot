...
public class UserDetailsImpl implements UserDetails {
    ...
    public static UserDetailsImpl build(User user) {
        ...
        return new UserDetailsImpl(user.getUserId(), user.getEmail(), user.getPassword(), user.getFirstName(),
                user.getLastName(), user.getPhoneNo(), user.isActiveFlag(), user.isApprovedFlag(), authorities);
    }
